...
const TeamCart = (props) => {
    // console.log(props);
    const { name, age, img, role, country, salary, gender } = props.team
    return (
        <div className="team">
            <div className="team-style">
                ...
                <div className="icon">
                    <h3><i className="fab fa-facebook-square"></i></h3>
                    <h3> <i className="fab fa-twitter-square"></i></h3>
                    <h3><i className="fab fa-github-square"></i></h3>
                </div>
